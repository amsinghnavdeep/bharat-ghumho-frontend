...
<section class="dash">
  <div class="w">
    <header class="dash-head">
      <div>
        ...
        <h1>{{ (auth.userSignal()?.name) || 'Traveler' }}</h1>
      </div>
      <div class="dash-tabs">
  ...
  styles: [`
    .dash{padding:120px 0 80px;background:#F7F8FA;min-height:100vh}
    .dash-head{display:flex;justify-content:space-between;align-items:flex-start;flex-wrap:wrap;gap:18px;margin-bottom:28px}
    .dash-head small{font-size:12px;color:#8B95A5;text-transform:uppercase;letter-spacing:1.2px;font-weight:700}
    .dash-head h1{font-size:36px;font-weight:900;letter-spacing:-1.5px;margin-top:4px}
    .dash-tabs{display:flex;gap:6px;background:#fff;border:1px solid #E5E9F0;border-radius:14px;padding:4px;flex-wrap:wrap}
    .dash-tabs button{padding:10px 18px;border:none;background:none;font-size:13px;font-weight:600;color:#3D4A5C;border-radius:10px;cursor:pointer;transition:all .25s}
    .dash-tabs button.active{background:#0B1120;color:#fff}
    .dash-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:14px;margin-bottom:28px}
    .stat-card{background:#fff;border:1px solid #E5E9F0;border-radius:16px;padding:18px;box-shadow:0 2px 8px rgba(0,0,0,.04)}
    .stat-card small{display:block;font-size:11px;color:#8B95A5;text-transform:uppercase;letter-spacing:1.2px;font-weight:700;margin-bottom:6px}
    .stat-card strong{font-size:24px;font-weight:900;letter-spacing:-1px;color:#0B1120}
    .dash-section{font-size:20px;font-weight:800;margin:24px 0 14px}
    .dash-list{display:flex;flex-direction:column;gap:12px}
    .dash-empty{background:#fff;border:1px dashed #E5E9F0;border-radius:16px;padding:32px;text-align:center;color:#8B95A5}
    ...
    .fav-card,.alert-card{background:#fff;border:1px solid #E5E9F0;border-radius:16px;padding:16px;box-shadow:0 2px 8px rgba(0,0,0,.04)}
